...
public class ProdutoQuantidade extends Produto {
	...
	@JoinColumn(name = "id_venda_fk",
		foreignKey = @ForeignKey(name = "fk_prod_qtda_venda"))
	private Venda venda;
	...
	public void adicionar(Integer quantidade, Integer estoque) throws DAOException, TipoChaveNaoEncontradaException {
