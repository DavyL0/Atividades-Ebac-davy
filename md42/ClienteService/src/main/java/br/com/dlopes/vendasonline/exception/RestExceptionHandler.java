package br.com.dlopes.vendasonline.exception;
...
import br.com.dlopes.vendasonline.errorhandling.ApiError;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler  {
    ...
    protected ResponseEntity<Object> handleFeignBadRequest(BadRequest ex) {
        ApiError apiError = new ApiError(HttpStatus.BAD_REQUEST);
        apiError.setMessage(ex.getMessage());
        return buildResponseEntity(apiError);
    }
    ...
    protected ResponseEntity<Object> handleFeignUnprocessableEntity(UnprocessableEntity ex) {
        ApiError apiError = new ApiError(HttpStatus.UNPROCESSABLE_ENTITY);
        apiError.setMessage(ex.getMessage());
        return buildResponseEntity(apiError);
    }
